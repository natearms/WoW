...
public static class FuzzyMatcher
{
    ...
    /// <param name="stringToSearch">The string to search for the pattern in.</param>
    /// <param name="pattern">The pattern to search for in the string.</param>
    /// <returns>The score which this search received, if a match was found. Otherwise int.MinValue</returns>
    public static int FuzzyMatchValue(string stringToSearch, string pattern)
    {
        int nonMatchValue = int.MinValue;
        int matchValue;
        if (FuzzyMatch(stringToSearch, pattern, out matchValue))
        {
            return matchValue;
        }
